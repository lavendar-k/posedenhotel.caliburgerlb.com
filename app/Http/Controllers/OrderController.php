    ...
    public function update(Request $request, Order $order)
    {
        ...
        foreach ($cart as $cartItem) {
            ...
            foreach($product->services as $service) {
                $tservice = (object) $service;
                if($tservice->is_selected){
                    $service_cost += $tservice->cost;
                    $service_price += $tservice->price;
                }
            }
            ...
            $order_detail->service_cost = $service_cost;
            $order_detail->total = $quantity * ($product->price + $service_price);
            $order_detail->total_cost = $quantity * ($product->cost + $service_cost);
